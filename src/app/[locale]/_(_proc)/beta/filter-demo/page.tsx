...
import ComplexFilterExample from '../../../../../design-system/ui/__examples__/ComplexFilterExample';

// Loading component for Suspense fallback
function ComplexFilterLoading() {
	return (
...
export default function FilterHookDemoPage() {
	return (
		<ContentLayout>
			<Suspense fallback={<ComplexFilterLoading />}>
