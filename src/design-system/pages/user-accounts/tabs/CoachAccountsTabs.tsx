...
import CoachAccountsTable from '../components/CoachAccountsTable';
import { CoachAccount } from '../types';
import TabNavigation, { TabItem } from '../../../ui/layout/content-tab-navigation';

interface CoachAccountsTabsProps {
  accounts: CoachAccount[];
}

const CoachAccountsTabs: React.FC<CoachAccountsTabsProps> = ({ accounts }) => {
...
export default CoachAccountsTabs;
