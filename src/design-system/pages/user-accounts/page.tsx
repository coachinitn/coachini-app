...
const UserAccountsPageAdmin = () => {
    ...
    // Generate tabs using the UserAccountsPageTabs function
    const tabs = UserAccountsPageTabs({
...
export default UserAccountsPageAdmin;
